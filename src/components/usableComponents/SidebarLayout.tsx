  ...
  return (
    <>
          ...
          <Link className={`nav-item ${isActive("/") ? "active" : ""}`} href="/">
            <span className="nav-icon">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                <path d="M3 9.5L12 3L21 9.5V20C21 20.55 20.55 21 20 21H4C3.45 21 3 20.55 3 20V9.5Z" stroke="currentColor" strokeWidth="1.5"/>
              </svg>
            </span>
            Homepage
          </Link>
      ...
      <div className={`mobile-menu ${open ? "show" : ""}`}>
        ...
        <Link href="/projects" className="mobile-link" onClick={() => setOpen(false)}>
          <span className="nav-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              <path d="M4 4H20V20H4V4Z" stroke="currentColor" strokeWidth="1.5"/>
            </svg>
        ...
        <Link href="/contacts" className="mobile-link" onClick={() => setOpen(false)}>
          <span className="nav-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              <path d="M4 4H20V14H4V4Z" stroke="currentColor" strokeWidth="1.5" />
              <path d="M4 14L12 20L20 14" stroke="currentColor" strokeWidth="1.5" />
